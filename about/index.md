...
<p>
  That said, I'm continuing to improve my existing apps in Flutter (as I adore the Dart language and I think maintaining a doorway to cross-platform is valuable), adding features and refining the experience based on user feedback. Coding while travelling can sometime be pretty hard - think dodgy connections and lack of deep focus among others! - so I'm mainly trying to implement ways to increase user conversion and ASO strategies for those already on the App Store.
</p>

<p>
  My long-term dream is to continue to grow my indie apps that provide real value to people while continuing to explore other creative projects (particularly nature/climate change focussed) and maybe collaborate with startups/companies building tools I believe in.
</p>
</section>
...
<div class="contact-links">
  <a href="mailto:hello@laurence-wayne.com" class="contact-link email">
    📧 <span>hello@laurence-wayne.com</span>
  </a>
  <a href="https://github.com/LanceWW0" class="contact-link github">
    🐙 <span>github.com/LanceWW0</span>
  </a>
  <a href="https://twitter.com/solodevdude" class="contact-link twitter">
    🐦 <span>@solodevdude</span>
  </a>
</div>
</section>
