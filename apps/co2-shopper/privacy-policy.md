...
<a href="/apps/co2-shopper/" class="back-link">← Back to CO2 Shopper</a>

<header class="privacy-header">
  <img class="app-icon" src="{{ page.app_icon }}" alt="CO2 Shopper App Icon" loading="lazy" decoding="async">
...
<section class="privacy-section">
  ...
  <p>CO2 Shopper respects your privacy. This page explains what data is (and isn't) collected, how it's used, and your rights as a user.</p>
</section>
...
<section class="privacy-section">
  ...
  <ul>
    <li>To provide the core functionality of CO2 Shopper (carbon footprint analysis of grocery receipts).</li>
...
<section class="privacy-section">
  ...
  <p>CO2 Shopper may make use of the following third-party services:</p>
...
<section class="privacy-section">
  ...
  <p>CO2 Shopper is not directed at children under 13. We do not knowingly collect data from children.</p>
</section>
