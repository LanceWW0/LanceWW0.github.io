...
<a href="/apps/pet-portrait-ai/" class="back-link">← Back to Pet Portrait AI</a>

<header class="privacy-header">
  <img class="app-icon" src="{{ page.app_icon }}" alt="Pet Portrait AI App Icon" loading="lazy" decoding="async">
...
<section class="privacy-section">
  ...
  <p>Pet Portrait AI respects your privacy. This page explains what data is (and isn't) collected, how it's used, and your rights as a user.</p>
</section>
...
<section class="privacy-section">
  ...
  <ul>
    <li><strong>Usage Information:</strong> We may collect information about your interaction with the app, such as the features you use and how often you use them. This also includes diagnostics and crash reports.</li>
...
<section class="privacy-section">
  ...
  <ul>
    <li>To provide the core functionality of Pet Portrait AI (generating pet portraits and related features).</li>
...
<section class="privacy-section">
  ...
  <p>Pet Portrait AI may make use of the following third-party services:</p>
  <div class="third-party-list">
    ...
    <div class="third-party-item">
      ...
      <span class="service-desc">Image generation</span>
    </div>
  </div>
...
<section class="privacy-section">
  ...
  <ul>
    <li>You can delete the app at any time, which removes all data from your device; however, your usage data may still be stored on our servers.</li>
...
<section class="privacy-section">
  ...
  <p>Pet Portrait AI is not directed at children under 13. We do not knowingly collect data from children.</p>
</section>
