...
<div style="text-align:center;">
  <h1 style="font-size:3em;">93 Million Tokens, One Very Bad Afternoon</h1>
  <h2 style="font-weight:normal; color:grey;">How a leaked API key burned through $91.60 of OpenAI credits in about 10 minutes.</h2>
  <p style="color:gray;">{{ page.date | date: "%B %-d, %Y" }}</p>
  <div style="max-width:800px; margin:0 auto;">
    <img src="/blog/93-million-tokens-one-very-bad-afternoon/header.png" alt="Header image for the blog post about a leaked OpenAI API key burning through credits." style="max-width:80%; height:auto; padding:16px; border-radius:24px;">
    ...
    <figure style="margin:16px auto; max-width:80%;">
      <img src="/blog/93-million-tokens-one-very-bad-afternoon/dashboard.png" alt="OpenAI usage dashboard showing 93,212,827 tokens used and $91.60 in spend." style="width:100%; height:auto; padding:16px; border-radius:24px; display:block;">
      <figcaption style="font-size:0.95em; color:gray; margin-top:4px;">93,212,827 tokens. In one afternoon. From an account that normally moves a few cents a day.</figcaption>
    </figure>
    -->
    <p style="font-size:1.35em; line-height:1.7;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">🐛 What Was Happening</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <figure style="margin:16px auto; max-width:80%;">
      <img src="/blog/93-million-tokens-one-very-bad-afternoon/usage_spike.png" alt="OpenAI usage chart showing one enormous spike on May 7 against a flat baseline." style="width:100%; height:auto; padding:16px; border-radius:24px; display:block;">
      <figcaption style="font-size:0.95em; color:gray; margin-top:4px;">The May 7 spike, against weeks of nothing.</figcaption>
    </figure>
    -->
    <p style="font-size:1.35em; line-height:1.7;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Step 1: Revoke Everything</h4>
    ...
    <figure style="margin:16px auto; max-width:80%;">
      <img src="/blog/93-million-tokens-one-very-bad-afternoon/empty_keys.png" alt="OpenAI API keys page showing no active keys." style="width:100%; height:auto; padding:16px; border-radius:24px; display:block;">
      <figcaption style="font-size:0.95em; color:gray; margin-top:4px;">A reassuringly empty keys list.</figcaption>
    </figure>
    -->

    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Step 2: Lower the Hard Limit</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Step 3: Watch the Lag</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Step 4: Open a Support Ticket</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">🕵️ Where Did the Key Leak From?</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">One Key Per App</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Per-Project Spend Caps</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">No More Keys in Notes</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Audit the Git History</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em; text-align:left;">Secrets Live in the Hosting Platform</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
