...
<div style="text-align:center;">
    ...
    <h2 style="font-weight:normal; color:grey;">How digging a hole can be rather like app building.</h2>
    <p style="color:gray;">{{ page.date | date: "%B %-d, %Y" }}</p>
    <div style="max-width:800px; margin:0 auto;">
        <img src="/blog/life-lessons-from-hole-digging/header.png" alt="Cartoon of a hole being dug using a spade and finding riches in the dirt." style="max-width:80%; height:auto; padding:16px; border-radius:24px;">
        ...
        <p style="font-size:1.35em; line-height:1.7;">
            Later that day, I complained to my Mum: <span style="font-style:italic; color:#555;">“Dearest Mar Mar, why must such tragedy befall me?”</span> (Or something like that anyway). She replied simply:
        </p>
        <blockquote style="font-size:1.5em; font-weight:bold; color:#FF7A59; margin:24px 0;">
    ...
    <footer class="post-footer">
      ...
      <!-- <p>Enjoyed this? You might also like <a href="/blog/creativity-and-failure/">Creativity and Failure: Learning to Build Without Fear</a>.</p> -->
    </footer>
</div>
