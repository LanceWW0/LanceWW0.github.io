...
<div style="text-align:center;">
  <h1 style="font-size:3em;">The Quest for England's River Health Data</h1>
  <h2 style="font-weight:normal; color:grey;">How I spent an Easter weekend downloading 25 years of water quality data one API call at a time — because the government deleted the download button.</h2>
  <p style="color:gray;">{{ page.date | date: "%B %-d, %Y" }}</p>
  <div style="max-width:800px; margin:0 auto;">
    <img src="/blog/the-quest-for-englands-river-health-data/header.png" alt="Header image for the blog post about downloading England's river health data from the Environment Agency API." style="max-width:80%; height:auto; padding:16px; border-radius:24px;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">The Dataset That Disappeared</h3>
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">The Email</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">The Plan</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <ul style="text-align:left; font-size:1.35em; line-height:1.7; max-width:700px; margin:16px auto;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">The Reality</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em;">The Concurrency Fix</h4>
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em;">The Slash Incident</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h4 style="margin-top:24px; font-weight:700; font-size:1.5em;">The SOSA Surprise</h4>
    <p style="font-size:1.35em; line-height:1.7; margin-top:8px;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">What Emerged from the Data</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <table style="margin:24px auto; border-collapse:collapse; font-size:1.2em; text-align:left;">
      <thead>
        <tr>
          <th style="padding:8px 16px; border-bottom:2px solid #333;">Status</th>
          <th style="padding:8px 16px; border-bottom:2px solid #333;">Points</th>
          <th style="padding:8px 16px; border-bottom:2px solid #333;">Percentage</th>
        </tr>
      </thead>
      <tbody>
        <tr><td style="padding:8px 16px;"><strong>High</strong></td><td style="padding:8px 16px;">1,311</td><td style="padding:8px 16px;">24%</td></tr>
        <tr><td style="padding:8px 16px;"><strong>Good</strong></td><td style="padding:8px 16px;">766</td><td style="padding:8px 16px;">14%</td></tr>
        <tr><td style="padding:8px 16px;"><strong>Moderate</strong></td><td style="padding:8px 16px;">452</td><td style="padding:8px 16px;">8%</td></tr>
        <tr><td style="padding:8px 16px;"><strong>Poor</strong></td><td style="padding:8px 16px;">613</td><td style="padding:8px 16px;">11%</td></tr>
        <tr><td style="padding:8px 16px;"><strong>Bad</strong></td><td style="padding:8px 16px;">2,115</td><td style="padding:8px 16px;">39%</td></tr>
        <tr><td style="padding:8px 16px;">Unknown</td><td style="padding:8px 16px;">205</td><td style="padding:8px 16px;">4%</td></tr>
      </tbody>
    </table>
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">What's Next</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
    ...
    <h3 style="margin-top:32px; font-weight:700; font-size:2em;">The Bigger Picture</h3>
    <p style="font-size:1.35em; line-height:1.7; margin-top:12px;">
